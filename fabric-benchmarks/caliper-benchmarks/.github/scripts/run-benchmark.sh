...
#taskset -c 0,1 npx caliper launch manager --caliper-workspace ./ --caliper-networkconfig networks/fabric/test-network.yaml --caliper-benchconfig $BENCHCONFIG --caliper-flow-only-test --caliper-fabric-gateway-enabled
